// layers/ports.js â€” Global port locations
// Sources tried in order:
//   1. ./data/ports.geojson  (local â€” download from HDX and place here for full dataset)
//   2. NGA World Port Index CSV via corsproxy
//   3. OSM Overpass â€” harbour=yes nodes (globally tagged, ~3000+ results)
//
// To get full 3700-port dataset:
//   Download: https://data.humdata.org/dataset/global-ports â†’ ports.geojson
...
WV.layers.ports = (function () {
  ...
  // â”€â”€ ANCHOR ICON â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  // White anchor on transparent background â€” tinted per size via Billboard color property
  ...
  function enable(viewer) {
    ...
    return fetchText('./data/ports.geojson')
      ...
      // 3. OSM Overpass â€” harbour=yes (broad tag, good global coverage)
      .catch(function () {
