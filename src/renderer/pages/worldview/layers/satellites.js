// layers/satellites.js â€” Real-time TLE satellite tracking via SGP4 orbit propagation
...
WV.layers.satellites = (function () {
  ...
  // SatNOGS is the best free TLE source but has no CORS headers â€” route through proxies.
  ...
  var TLE_SOURCES = [
    // SatNOGS via corsproxy â€” SatNOGS doesn't block proxy IPs (unlike CelesTrak)
    { url: 'https://corsproxy.io/?' + encodeURIComponent(_SATNOGS),
      isJson: true,  parser: 'satnogs' },
    // SatNOGS via codetabs â€” second proxy pool
    { url: 'https://api.codetabs.com/v1/proxy?quest=' + encodeURIComponent(_SATNOGS),
      isJson: true,  parser: 'satnogs' },
    // CelesTrak text via codetabs â€” different IP pool, may not be on their blocklist
    { url: 'https://api.codetabs.com/v1/proxy?quest=' + encodeURIComponent(_CELESTRAK),
      isJson: false, parser: 'tle' },
    // CelesTrak text via allorigins â€” last resort (fails from localhost, works in prod)
  ...
  // â”€â”€ PARSERS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ FETCH WITH SOURCE FALLBACK â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ SATELLITE ICON â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ POSITION PROPAGATION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  function getPos(satrec, date) {
    try {
      ...
      var alt  = gd.height * 1000; // km â†’ metres
  ...
  // â”€â”€ ORBITAL PATH â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ SELECT / TRACK â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  function select(idx) {
    ...
    drawOrbit(s.satrec);
    WV.Controls.setStatus('TRACKING: ' + s.name + ' â€” CLICK GLOBE TO RELEASE');
  ...
  // â”€â”€ POSITION REFRESH â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ ENABLE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    return tryNext(TLE_SOURCES, 0)
      .then(function (all) {
        ...
        satrecs.forEach(function (s, i) {
          ...
          // Truncate long names (e.g. "STARLINK-1234" â†’ keep as-is, "OBJECT..." â†’ trim)
      ...
      .catch(function (err) {
        ...
        WV.Controls.setStatus('SAT: all data sources failed â€” check console');
      });
  }

  // â”€â”€ DISABLE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
