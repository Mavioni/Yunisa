// layers/military.js â€” Military flight tracking via adsb.lol
...
WV.layers.military = (function () {
  ...
  var posHistory  = {};   // hex â†’ [{lat, lon, alt}, ...]
  var trackedHex  = null;
  var pathEntity  = null;
  var MAX_HIST    = 20;
  ...
  // â”€â”€ PATH DRAWING â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ SELECT / TRACK â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  function select(hex) {
    trackedHex = hex;
    var v = WV.viewer;
    if (!v) return;
    ...
    WV.Controls.setStatus('TRACKING MIL: ' + hex.toUpperCase() + ' â€” CLICK GLOBE TO RELEASE');
  }
  ...
  // â”€â”€ FETCH + RENDER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          ...
          pointCollection.add({
            ...
            id: {
              ...
              _wvMeta: [
                ...
                { key: 'HEADING',  val: a.track ? Math.round(a.track) + 'Â°' : '---' },
